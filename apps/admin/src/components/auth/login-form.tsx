...
export function LoginForm() {
  ...
  return (
    <main className="relative isolate grid min-h-svh grid-rows-[auto_1fr_auto] overflow-x-hidden px-5 text-foreground max-[560px]:px-[1.125rem] md:px-[clamp(2rem,4vw,4rem)]">
      <span
        aria-hidden="true"
        className="pointer-events-none fixed bottom-[-0.2em] left-[clamp(1.25rem,4vw,4rem)] -z-10 select-none text-[16rem] leading-[0.8] font-semibold tracking-normal text-foreground/[0.035] min-[561px]:text-[27.5rem] min-[1100px]:text-[38.75rem]"
      >
        M
      </span>

      <header className="flex min-h-[4.75rem] items-center gap-2.5 border-b border-border max-[560px]:min-h-[4.25rem]">
        ...
        <ThemeMenu className="ml-auto [&>button]:size-11 [&>button]:min-h-11" />
      </header>

      <section className="mx-auto grid w-full max-w-[73.75rem] items-center gap-6 py-7 min-[561px]:gap-9 min-[561px]:py-10 min-[861px]:grid-cols-[minmax(0,1fr)_minmax(22.5rem,26.875rem)] min-[861px]:gap-[clamp(3rem,8vw,8rem)] min-[861px]:py-[clamp(3rem,8vh,5.75rem)]">
        <div className="max-w-[38.125rem]">
          ...
          <h1 className="text-[2rem] leading-[1.06] font-semibold tracking-normal min-[561px]:text-[2.625rem] min-[861px]:text-[4.25rem]">
      ...
      <footer className="flex min-h-[4.25rem] flex-wrap items-center gap-3 border-t border-border py-3.5 text-[0.65625rem] tracking-[0.02em] text-muted">
